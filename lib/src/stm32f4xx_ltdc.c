...
void LTDC_Init(LTDC_InitTypeDef* LTDC_InitStruct)
{
    ...
    LTDC->GCR |= (uint32_t)(LTDC_InitStruct->LTDC_HSPolarity | LTDC_InitStruct
        ->LTDC_VSPolarity | LTDC_InitStruct->LTDC_DEPolarity | LTDC_InitStruct
        ->LTDC_PCPolarity);
    ...
    LTDC->BCCR |= (backred | backgreen | LTDC_InitStruct
    ...
    LTDC_Layer_InitTypeDef* LTDC_Layer_InitStruct)
{
    ...
    LTDC_Layerx->BFCR =
        (LTDC_Layer_InitStruct->LTDC_BlendingFactor_1 | LTDC_Layer_InitStruct
