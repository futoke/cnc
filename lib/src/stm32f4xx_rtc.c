...
ErrorStatus RTC_SetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
    ...
    if (RTC_Format != RTC_Format_BIN) {
        tmpreg =
            (((uint32_t)(RTC_TimeStruct->RTC_Hours) << 16) | ((uint32_t)(RTC_TimeStruct
                ->RTC_Minutes) << 8) | ((uint32_t)RTC_TimeStruct->RTC_Seconds) | ((uint32_t)(RTC_TimeStruct
                ->RTC_H12) << 16));
    } else {
        tmpreg =
            (uint32_t)(((uint32_t)RTC_ByteToBcd2(RTC_TimeStruct->RTC_Hours) << 16) | ((uint32_t)RTC_ByteToBcd2(
                RTC_TimeStruct->RTC_Minutes) << 8) | ((uint32_t)RTC_ByteToBcd2(
                RTC_TimeStruct->RTC_Seconds)) | (((uint32_t)RTC_TimeStruct
                ->RTC_H12) << 16));
    }
...
ErrorStatus RTC_SetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
    ...
    if (RTC_Format != RTC_Format_BIN) {
        tmpreg =
            ((((uint32_t)RTC_DateStruct->RTC_Year) << 16) | (((uint32_t)RTC_DateStruct
                ->RTC_Month) << 8) | ((uint32_t)RTC_DateStruct->RTC_Date) | (((uint32_t)RTC_DateStruct
                ->RTC_WeekDay) << 13));
    } else {
        tmpreg =
            (((uint32_t)RTC_ByteToBcd2(RTC_DateStruct->RTC_Year) << 16) | ((uint32_t)RTC_ByteToBcd2(
                RTC_DateStruct->RTC_Month) << 8) | ((uint32_t)RTC_ByteToBcd2(
                RTC_DateStruct->RTC_Date)) | ((uint32_t)RTC_DateStruct
                ->RTC_WeekDay << 13));
    }
    ...
    RTC_AlarmTypeDef* RTC_AlarmStruct)
{
    ...
    if (RTC_Format != RTC_Format_BIN) {
        tmpreg =
            (((uint32_t)(RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours) << 16) | ((uint32_t)(RTC_AlarmStruct
                ->RTC_AlarmTime.RTC_Minutes) << 8) | ((uint32_t)RTC_AlarmStruct
                ->RTC_AlarmTime.RTC_Seconds) | ((uint32_t)(RTC_AlarmStruct
                ->RTC_AlarmTime.RTC_H12) << 16) | ((uint32_t)(RTC_AlarmStruct
                ->RTC_AlarmDateWeekDay) << 24) | ((uint32_t)RTC_AlarmStruct
                ->RTC_AlarmDateWeekDaySel) | ((uint32_t)RTC_AlarmStruct
                ->RTC_AlarmMask));
    } else {
        tmpreg =
            (((uint32_t)RTC_ByteToBcd2(RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours) << 16) | ((uint32_t)RTC_ByteToBcd2(
                RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes) << 8) | ((uint32_t)RTC_ByteToBcd2(
                RTC_AlarmStruct->RTC_AlarmTime.RTC_Seconds)) | ((uint32_t)(RTC_AlarmStruct
                ->RTC_AlarmTime.RTC_H12) << 16) | ((uint32_t)RTC_ByteToBcd2(
                RTC_AlarmStruct->RTC_AlarmDateWeekDay) << 24) | ((uint32_t)RTC_AlarmStruct
                ->RTC_AlarmDateWeekDaySel) | ((uint32_t)RTC_AlarmStruct
                ->RTC_AlarmMask));
    }
    ...
    RTC_AlarmTypeDef* RTC_AlarmStruct)
{
    ...
    RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours =
        (uint32_t)((tmpreg & (RTC_ALRMAR_HT |
        RTC_ALRMAR_HU)) >> 16);
    RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes =
        (uint32_t)((tmpreg & (RTC_ALRMAR_MNT |
        RTC_ALRMAR_MNU)) >> 8);
    RTC_AlarmStruct->RTC_AlarmTime.RTC_Seconds =
        (uint32_t)(tmpreg & (RTC_ALRMAR_ST |
        RTC_ALRMAR_SU));
    ...
    uint32_t RTC_AlarmSubSecondMask)
{
    ...
    tmpreg =
        (uint32_t)(uint32_t)(RTC_AlarmSubSecondValue) | (uint32_t)(RTC_AlarmSubSecondMask);
    ...
    uint32_t RTC_SmouthCalibMinusPulsesValue)
{
    ...
    if ((RTC->ISR & RTC_ISR_RECALPF) == RESET) {
        ...
        RTC->CALR =
            (uint32_t)((uint32_t)RTC_SmoothCalibPeriod | (uint32_t)RTC_SmoothCalibPlusPulses | (uint32_t)RTC_SmouthCalibMinusPulsesValue);
...
void RTC_ClearFlag(uint32_t RTC_FLAG)
{
    ...
    RTC->ISR =
        (uint32_t)((uint32_t)(~((RTC_FLAG | RTC_ISR_INIT) & 0x0000FFFF) | (uint32_t)(RTC
            ->ISR & RTC_ISR_INIT)));
}
...
void RTC_ClearITPendingBit(uint32_t RTC_IT)
{
    ...
    RTC->ISR =
        (uint32_t)((uint32_t)(~((tmpreg | RTC_ISR_INIT) & 0x0000FFFF) | (uint32_t)(RTC
            ->ISR & RTC_ISR_INIT)));
}
