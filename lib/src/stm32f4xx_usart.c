...
void USART_Init(USART_TypeDef* USARTx, USART_InitTypeDef* USART_InitStruct)
{
    ...
    tmpreg |= (uint32_t)USART_InitStruct->USART_WordLength | USART_InitStruct
    ...
    if ((USARTx->CR1 & USART_CR1_OVER8) != 0) {
        ...
        integerdivider = ((25 * apbclock) / (2 * (USART_InitStruct
            ->USART_BaudRate)));
    ...
    USART_ClockInitTypeDef* USART_ClockInitStruct)
{
    ...
    tmpreg |=
        (uint32_t)USART_ClockInitStruct->USART_Clock | USART_ClockInitStruct
