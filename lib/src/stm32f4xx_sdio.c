...
void SDIO_Init(SDIO_InitTypeDef* SDIO_InitStruct)
{
    ...
    tmpreg |=
        (SDIO_InitStruct->SDIO_ClockDiv | SDIO_InitStruct->SDIO_ClockPowerSave | SDIO_InitStruct
...
void SDIO_SendCommand(SDIO_CmdInitTypeDef *SDIO_CmdInitStruct)
{
    ...
    tmpreg |= (uint32_t)SDIO_CmdInitStruct->SDIO_CmdIndex | SDIO_CmdInitStruct
...
void SDIO_DataConfig(SDIO_DataInitTypeDef* SDIO_DataInitStruct)
{
    ...
    tmpreg |=
        (uint32_t)SDIO_DataInitStruct->SDIO_DataBlockSize | SDIO_DataInitStruct
            ->SDIO_TransferDir | SDIO_DataInitStruct->SDIO_TransferMode | SDIO_DataInitStruct
            ->SDIO_DPSM;
